...
<header>    
    <div class="header-container">  
        ...
        <div class = "infor">
            <a href="https://maps.app.goo.gl/44d1MoKdpKSY5fPr9" target="_blank"><img src = "../asset/images/icon/location.gif"></a>
            <div>
...
<nav>
    <ul>
        ...
        <li><a href="../pages/index.php?page=cart">Giỏ hàng</a></li>
        <div class ="phai">
